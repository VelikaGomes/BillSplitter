...
const Home = ({ onStart }) => {
  return (
    <div style={{ backgroundColor:'#E1DACA', textAlign: 'center', width:'100%', height:'100vh', padding:'10px' }}>
      ...
      <button style={{ backgroundColor:'#CC5500', width:'50%', height:'50px', borderRadius:'15px',color:'white', fontSize:'15px', padding:'5px' , borderStyle:'none'}}onClick={onStart}>Scan Receipt</button>
      <br /><br />
